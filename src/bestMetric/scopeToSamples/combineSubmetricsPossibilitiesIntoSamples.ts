...
const combineSubmetricsPossibilitiesIntoSamples = ({
    ...
    dynamicParameters,
}: CombineSubmetricsPossibilitiesIntoSamplesOptions): Sample[] => {
    ...
    submetricsPossibilities.forEach(
        (submetricPossibilities: Combination<SubmetricPossibility>, submetricIndex: number): void => {
...
export { combineSubmetricsPossibilitiesIntoSamples }
