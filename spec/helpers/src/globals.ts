...
import {DEFAULT_POPULARITY_METRIC_LFC_SCRIPTS_SETTINGS, INITIAL_SOLVER_STATUS} from "../../../src/constants"
import {
    bestMetrics,
...
afterEach((): void => {
    ...
    setAllPropertiesOfObjectOnAnother({
        ...
        objectWithProperties: DEFAULT_POPULARITY_METRIC_LFC_SCRIPTS_SETTINGS,
    })
})
