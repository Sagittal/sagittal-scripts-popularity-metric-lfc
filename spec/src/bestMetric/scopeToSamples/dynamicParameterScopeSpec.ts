...
describe("computeDynamicParameterScope", (): void => {
    ...
    it("given only a min, errors", (): void => {
        ...
        expect((): void => {
            ...
            "Exactly 2 options should be provided from min, max, center, and window in order to compute a dynamic parameter scope; 1 provided (min -2)",
        )
    })
    ...
    it("given only a max, errors", (): void => {
        ...
        expect((): void => {
            ...
            "Exactly 2 options should be provided from min, max, center, and window in order to compute a dynamic parameter scope; 1 provided (max 0)",
        )
    })
    ...
    it("given only a max, errors", (): void => {
        ...
        expect((): void => {
            ...
            "Exactly 2 options should be provided from min, max, center, and window in order to compute a dynamic parameter scope; 1 provided (window 2)",
        )
    })
    ...
    it("given only a max, errors", (): void => {
        ...
        expect((): void => {
            ...
            "Exactly 2 options should be provided from min, max, center, and window in order to compute a dynamic parameter scope; 1 provided (center -1)",
        )
    })
    ...
    it("given more than two options, errors", (): void => {
        ...
        expect((): void => {
            ...
            "Exactly 2 options should be provided from min, max, center, and window in order to compute a dynamic parameter scope; 4 provided (min -2, max 0, center -1, window 2)",
        )
    })
})
